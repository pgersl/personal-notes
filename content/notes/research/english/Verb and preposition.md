...
- **dream of/about**
    - -> _Do you dream of/about being rich._
- **I wouldn't dream of** = _I would never do it_
    - -> _I wouldn't dream of killing someone._
### _Complain_
- **complain about**
    - -> _We complained to the manager of the restaurant about about the food._
- **complain of**
    - -> _We called the doctor because George was complaining of a pain in his stomach._
### _Remind_
- _**remind** somebody **about**_
    - -> _It's good you reminded me about the meeting._
- **remind somebody of**
    - -> _This house reminds me of the one I lived in when I was a child._
## _Take care of, care for_ a _care about_
- **take care of** = _look after, keep safe, take responsibility of_
    - -> _Don't worry about me. I can take care of myself._
- **care for somebody** = _take care of them, keep them safe_
    - -> _Alan is 85 and lives alone. He needs somebody to take car for him._
    - _I don't care for something_ = _I don't like it_
        - -> _I don't care for hot weather._
- **care about** = _think that somebody/something is important_
    - -> _He's very selfish. He doesn't care about other people._
## _Look for_ a _look after_
- **look for** = _search for, try to find_
    - -> _I've lost my keys. Can you help me to look for them._
- **look after** = _take care of, keep sade or in good condition_
    - -> _Alan is 85 and lives alone. He needs somebody to look after him._
# _In, into, with, to_ and _on_
## Spojení s _in_
- **believe in**
    - -> _Do you believe in God?_
- **specialise in**
    - -> _Helen is a lawyer. She specialises in company law._
- **succeed in**
    - -> _I hope you succeed in finding the job you want._
## Spojení s _into_
- **break into**
    - -> _Our house was broken into a few days ago, but nothing was stolen._
- **crash/drive/bump/run into**
    - -> _He lost control of the car and crashed into three parts._
- **divide/cut/split into**
    - -> _The book is divided into three parts._
- **translate (from ...) into**
    - -> _She's a famous writer. Her books have been translated into many languages._
## Spojení s _with_
- **collide with**
    - -> _There was an accident this morning. A bud collided with a car._
- **fill with**
    - -> _Take this saucepan and fill it with water._
- **provide/supply with**
    - -> _The school provides all its students with books._
## Spojení s _to_
- **happen to**
