...
{{< fig class="note-fig" src="https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2FPetrGersl%2FpYfojWCCgT.png?alt=media&token=e1a7f4c1-d04a-465d-93e7-b2b48812bd7b" alt="Schéma průběhu primární fáze fotosyntézy" >}}
...
- vede jak ke vzniku hexosy tak k obnovení původního organického akceptoru _riboluse-1,5-bisfosfátu_
- zkratky
    - $C_1$ - $CO_2$
    - $C_3K$ - _3-fosfoglycerová kyselina_
    - $C_3A$ - _glyceraldehyd-3-fosfát_
    - $C_4?$ - neznámý čtyřuhlíkatý produkt
    - $C_5$ - _ribolusa-1,5-bisfosfát_
    - $C_5X$ - pentosa
...
- $C_3$-rostliny používají jako akceptor $CO_2$ _ribolusu-1,5-bisfosfát_
- $C_4$-rostliny používají jako akceptor $CO_2$ dvě molekuly _fosfoenolpyruvátu_
